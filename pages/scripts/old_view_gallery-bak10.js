...
class TextClip extends createjs.Text {
    ...
    makeTextClip(
        ...
        console.log(" this.textClip.width: ", this.textClip.width);
...
function init() {
    ...
    baseTextToComfy = Math.max(baseTextTo10PxTo10Percent * 1.601, 16); //1.601 @1000px, comfy≈16 (alt9463)
...
function reportClick() {
    ...
    subject.clear();
    stage.update();
    console.log(" subject.width: ", subject.getBounds());
