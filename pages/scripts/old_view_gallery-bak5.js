...
function init() {
    ...
    //TODO: got to figure this lousy math
    scaleFactor =
        parseInt(
            parseFloat(
    ...
    stageTextSize = parseInt(parseFloat(13.345 * scaleFactor * 100)) / 100;

    console.log(" this stageTextSize: ", stageTextSize);

    dimsTextTest = new textClip();
    dimsTextTest.makeTextClip("M", "normal", 10, "sans-serif", "#00FF00");

    dimsTextSize = dimsTextTest.getMeasuredWidth() * 1.11075;
    // stage.addChild(dimsTextTest);

    /*   dimsTextTest.set({
        text: "  font: v",
    }); */
    // Text.prototype.snapToPixel = true;
    console.log("dimsTextSize: ", dimsTextSize);
    ...
    */
    ...
    //added resize to test.
    // window.addEventListener("resize", reportSizeChange);
    ...
    console.log("element:? ", displayArea.fsDisplayWin);
...
/* 
createjs.Container.prototype.resize = function () {console.log("hey, you resized me.")}; */
