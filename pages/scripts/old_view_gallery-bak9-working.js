...
//resizeToKnownDimensions returns an array with 3 members: [contentW, contentH, aspect]; (and it's WRONG, due to the aspect!)
...
class MovieClip extends createjs.MovieClip {
    constructor() {
        super();
        this.movieClip;
        this.name = "mc_" + Math.random(1024);
...
function init() {
    ...
    baseTextToComfy = baseTextTo10PxTo10Percent * 1.601;
...
function reportClick() {
    ...
    console.log("getNumberResized(20): ", getNumberResized(20));
    console.log("baseTextTo10Px: ", baseTextTo10Px);
...
function stageSetupNowStart() {
    ...
    console.log("tempClip.getBounds(): ", tempClip.getBounds());
